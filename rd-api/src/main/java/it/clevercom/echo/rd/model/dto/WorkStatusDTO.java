...
public class WorkStatusDTO extends AbstractEchoDTO implements Serializable {
	...
	public WorkStatusDTO(String code, Date created, Date updated, String userupdate, Boolean active) {
		this.code = code;
