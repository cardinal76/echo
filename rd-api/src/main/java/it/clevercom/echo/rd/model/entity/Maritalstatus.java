...
/**
 * The persistent class for the rd_maritalstatus database table.
 * 
 */
@Entity
...
public class Maritalstatus implements Serializable {
	...
	@OneToMany(mappedBy="rdMaritalstatus")
	...
	public Patient addRdPatient(Patient rdPatient) {
		...
		rdPatient.setRdMaritalstatus(this);
	...
	public Patient removeRdPatient(Patient rdPatient) {
		...
		rdPatient.setRdMaritalstatus(null);
